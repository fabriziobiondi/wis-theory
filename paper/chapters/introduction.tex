...
$H_g(P)=g(\sum_i P_i\,h(-\log P_i))$ (with $h=g^{-1}$ for Shannon and
R\'enyi, and $h(y)=e^{(1-\alpha)y}$ for Tsallis), whose Lipschitz constant is
...
$11$--$590\times$ wider than the actual gap.  The quadratic bound
with the pointwise Hessian constant is $12$--$32\times$ wider than the
exact R\'enyi identity.  The bounds
...
critical points form a two-parameter family
(Corollary~\ref{ch:cor:three-level-family}), and the transition from
