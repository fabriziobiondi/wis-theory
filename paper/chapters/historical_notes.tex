...
exemplified by Pinsker's inequality $\operatorname{KL}(P\|Q)\ge\frac12\|P-Q\|_{\mathrm{TV}}^2$, where $\|P-Q\|_{\mathrm{TV}}=\sum_i|P_i-Q_i|$ is the unnormalised total variation (twice the normalised TV used in Chapter~\ref{ch:sec:comparative}),
