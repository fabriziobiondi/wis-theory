...
In the language of weighted incidence structures, this is precisely
the condition that the posterior distribution be uniform on the set of
messages compatible with the observed ciphertext.  Equivalently, the
Universal Optimality Defect $\mathcal D(P)$ vanishes for every
...
exactly---every message-ciphertext pair is unique, and every posterior
is a Dirac mass.
