...
Since \(F\) is a local diffeomorphism and the pullback metric is defined
...
\section{Characterization of Critical Points}\label{ch:sec:characterisation-of-critical-points}
...
The injectivity of \(F\) (Part~\ref{ch:part:posterior}) implies \(P=Q\). 
\end{proof}
