...
($n=100$), the UOD is $\mathcal D = 6/\varepsilon^2 = 24$ in
natural units (approximately $50$ bit$^2$), and the bound gives
$H_2(P) \ge \log_2 100 - 50/100 \approx 6.14$ bits.  The actual
collision entropy is approximately $6.60$ bits---the bound is
accurate to within about $0.5$ bits.
