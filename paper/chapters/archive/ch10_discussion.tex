...
The development unfolds in four integrated layers.  The combinatorial
layer (Chapters~3--6) identifies weighted incidence structures as the
...
factorization, establishes their gauge uniqueness, and completely
...
incidence graph.  The linearization layer (Chapter~7) takes logarithms
of the multiplicative WIS factorization, revealing an additive
...
representation, not chosen.  The analytic layer (Chapter~8) then
...
constructions.  They are successive consequences of one canonical
linearization.
...
\subsection*{Perfect secrecy and posterior symmetry}
...
\subsection*{Universal Optimality and Apollonian Cell Encoders}
...
answer is a complete characterization through weighted incidence
...
\subsection*{Matrix scaling, biproportional fitting, and weighted incidence structures}
The algebraic factorization $n_{mc}=\beta(c)/w(m)$ strongly resembles
...
Although the multiplicative factorization is algebraically similar,
...
work, conversely, derives the multiplicative factorization from Bayes'
...
Uniqueness of the factorization up to componentwise scaling
...
\subsection*{Graph Laplacians, graph potentials, and operator theory}
...
structural characterization of deterministic universally optimal
encryption systems together with the canonical Hilbert-space geometry
its associated Hilbert-space formalism.
...
geometry forced by that characterization.  Weighted incidence
