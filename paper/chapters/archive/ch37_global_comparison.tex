...
\paragraph{Local versus Global Behaviour.}
...
\end{itemize}
    probability differences.
\subsection{Comparison with Total Variation}\label{ch:thm:26-1}
...
still diverges. By Theorem~\ref{ch:thm:23-5},
...
$0\le H(PTheorem~\ref{ch:thm:26-1} Theorem 26.1, the UOD diverges along suitable sequences approaching
...
globally as a function of the Hellinger distance. 
\end{theorem}
\subsection{Local Comparison with Pearson's Chi-Squared Divergence}
...
Thus both quantities possess quadratic local expansions, but they induce
different quadratic forms.
\subsection{First Structural Comparison with KL}
