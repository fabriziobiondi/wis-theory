...
The mismatch operator $\Phi=[A\; -C]$ sends a pair of vertex potentials $(u,v)$ to the vector $\omega=\Phi(u,v)$ whose components are $\omega_{mc}=u_m-v_c$.
