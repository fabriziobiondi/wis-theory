...
The logarithmic linearisation of this chapter is the bridge between algebra and geometry. It produces the mismatch operator $\Phi$, which will be the central object of the next chapter, where it defines the least-squares problem and the posterior Laplacian.

This section shows that every WIS canonically determines a linear
