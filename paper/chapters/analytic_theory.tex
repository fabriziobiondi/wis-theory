...
This chapter introduces the three complementary perspectives---algebraic, differential, and functional-analytic---that organise Part~V. The analytic theory of this chapter (Chapter~\ref{ch:sec:analytic-uod}) is developed concretely in Chapters~21--23, and its variational consequences appear in Chapters~24--25.
