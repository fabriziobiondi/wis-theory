...
expression in the WIS coordinates is $\operatorname{diag}(e^{x_i-n})$,
which is positive definite.  Since the pullback metric is flat, this
implies geodesic convexity.\end{proof}
