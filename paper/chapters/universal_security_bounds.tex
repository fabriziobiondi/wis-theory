...
This chapter unifies the smooth and piecewise-smooth theories and establishes a complete classification of security functionals by their regularity. The universal bounds derived here are the culminating results of Part~IV and provide the tools for the security analysis of Chapter~\ref{ch:sec:applications-of-the-wis-framework}.
